/**
https://github.com/simonkorl/dtp_utils
*/
...
/// | the gap between two adjasent sending | the deadline goal | the block size
/// | the priority. Higher the number is, higher the priority is.|
